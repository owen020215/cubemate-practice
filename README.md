# CubeMate 魔方顶层练习网站 By Owen Sun

此网站用于魔方公式整理与练习
主要解决的痛点：
1. 无法自定义公式做法
2. 无法自选练习合集
3. 无法针对公式生成打乱，市面上的大多工具的打乱公式过长
...
直接用浏览器打开[https://owen020215.github.io/cubemate-practice/](https://owen020215.github.io/cubemate-practice/)就可以使用。
本地地址： [index.html](/Users/owensun/Documents/Playground/index.html)
...
- 如果只是想更新线上内容，用 GitHub 网页上传新的 `data.json` 就可以
